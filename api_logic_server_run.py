...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 09.02.04, August 11, 2023 11:22:01):
...
app_logger.info(f'Created August 11, 2023 11:22:01 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 09.02.04\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 09.02.04\n'
    if is_docker():
