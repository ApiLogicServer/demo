...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 09.02.18, August 22, 2023 10:47:09):
...
app_logger.info(f'Created August 22, 2023 10:47:09 at {str(current_path)}\n')
