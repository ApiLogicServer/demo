...
==============================================================================
    ...
    This file initializes and starts the API Logic Server (v 08.02.06, April 26, 2023 07:29:28):
...
app_logger.info(f'Created April 26, 2023 07:29:28 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 08.02.06\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 08.02.06\n'
    if is_docker():
