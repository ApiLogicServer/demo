...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 09.02.18, August 22, 2023 14:57:42):
...
app_logger.info(f'Created August 22, 2023 14:57:42 at {str(current_path)}\n')
