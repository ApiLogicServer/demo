...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 09.01.00, July 04, 2023 18:58:47):
...
app_logger.info(f'Created July 04, 2023 18:58:47 at {str(current_path)}\n')
