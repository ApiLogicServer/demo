...
==============================================================================
    ...
    This file initializes and starts the API Logic Server (v 08.02.05, April 25, 2023 12:51:54):
...
app_logger.info(f'Created April 25, 2023 12:51:54 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 08.02.05\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 08.02.05\n'
    if is_docker():
