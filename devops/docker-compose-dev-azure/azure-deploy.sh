...
az webapp create --resource-group $resourcegroup --plan myAppServicePlan --name demo --multicontainer-config-type compose --multicontainer-config-file devops/docker-compose-dev-azure/docker-compose-dev-azure.yml
